# The-smart-automatic-Safety-gate-
This project uses an Arduino, ultrasonic sensor, buzzer, and servo motor to detect nearby obstacles and automatically close the safety gate
## **1\. Abstract**
